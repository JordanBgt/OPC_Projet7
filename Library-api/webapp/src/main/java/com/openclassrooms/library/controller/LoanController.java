...
public class LoanController {
     ...
     *
     * @return a response com.openclassrooms.consumer.entity with a status representing the success or failure of the extension
     ...
     *
     * @return a response com.openclassrooms.consumer.entity with no content status
